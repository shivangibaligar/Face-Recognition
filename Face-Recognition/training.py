...
#goes to sub directories and store store images with their respective labels
def getImagesAndLabels(path):
    ...
    for imagePath in imagePaths:
        ...
        faces=classifier.detectMultiScale(imageNp)
...
faces,faceIds = getImagesAndLabels('dataSet')
